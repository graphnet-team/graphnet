...
<details>
<summary><b>Tasks using Monte Carlo only (High Energy neutrino classification and reconstruction, GNN pulse cleaning, Upgrade reconstruction, and Elasticity regression)</b></summary>
<blockquote>
