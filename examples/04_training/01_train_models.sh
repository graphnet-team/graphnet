...
gpus=0
# the maximum number of epochs; this greatly affect learning rate scheduling
max_epochs=5
...
declare -a model_configs=(
    "${model_directory}/dynedge_energy_example.yml"
    "${model_directory}/dynedge_position_example.yml"
)
