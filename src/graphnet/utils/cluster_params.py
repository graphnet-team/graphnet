...
from graphnet.utils.cluster.containers import RelationalDict
...
class ClusterSubmitter(object) :
    ...
    def _init_cluster_site(self, cluster_name=None) :
        ...
        icecube_clusters = { "icecube_npx" : "submit-1.icecube.wisc.edu", "icecube_grid" : "sub-1.icecube.wisc.edu" }
