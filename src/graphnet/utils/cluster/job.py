...
class ClusterCommand(object) :  
    ...
    def __init__(self, command, description=None, allowed_return_status=DEFAULT_ALLOWED_RETURN_STATUS) :
        ...
        assert isinstance(allowed_return_status,numbers.Number) or isinstance(allowed_return_status,collections.Sequence) or allowed_return_status is None, "`allowed_return_status` must be a number, list of numbers, or None"
...
class ClusterJob(object) :  
    ...
    def __init__(self,job_index,commands,description=None,env_vars=None) :
        ...
        assert isinstance(commands,collections.Sequence), "Commands must be a list or similar"
