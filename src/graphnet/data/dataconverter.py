...
class DataConverter(ABC, Logger):
    ...
    @final
    def __call__(self, directories: Union[str, List[str]], recursive: Optional[bool] = True) -> None:
        ...
        i3_files, gcd_files = find_i3_files(directories, self._gcd_rescue, recursive)
        if len(i3_files) == 0:
