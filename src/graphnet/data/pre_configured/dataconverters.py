...
class I3ToLMDBConverter(DataConverter):
    ...
    def __init__(
        ...
        Args:
            ...
            data_representation: Optional `DataRepresentation` instance or list
                                ...
                                the stored value will contain a
                                "data_representations" field with outputs from
                                each `data_representation.forward(...)` keyed
                                by class name.
