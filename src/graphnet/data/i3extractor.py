...
def get_primary_particle_interaction_type_and_elasticity(
    frame, sim_type, padding_value=-1
):
...
def muon_stopped(truth, borders, horizontal_pad=100.0, vertical_pad=100.0):
    """
